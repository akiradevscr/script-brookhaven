...
Sound:Play();
local args1 = {[1] = "RolePlayName", [2] = "Gui Akira"};
...
local args4 = {[1] = "RolePlayBio", [2] = "Akira Hub"};
game:GetService("ReplicatedStorage").RE:FindFirstChild(
...
CRD:AddLabel("Dev - Scritp: Akira_dev");
local function copyText()
    local textToCopy = "https://discord.gg/u9gPKEf5UR";
...
TT:AddButton({
    ...
    Callback = function()
        ...
        for i, all in pairs(Players:GetPlayers()) do
            ...
            game:GetService("ReplicatedStorage").RemoteEvents.PlayerTriggerEvent:FireServer(unpack(args1))
            
            local args2 = {
                [1] = "BothWantPiggyBackRide",
                [2] = game:GetService("Players")[all.Name]
            }
            game:GetService("ReplicatedStorage").RemoteEvents.PlayerTriggerEvent:FireServer(unpack(args2))
        end
    end
})
